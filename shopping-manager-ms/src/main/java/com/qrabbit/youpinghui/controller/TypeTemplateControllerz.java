...
import com.qrabbit.youpinghui.service.TypeTemplateServicez;
...
public class TypeTemplateControllerz {

	@Autowired
	private TypeTemplateServicez typeTemplateService;
...
//	 */
	...
	public ResultPageSeller search(@RequestBody TbTypeTemplate typeTemplate, int page, int rows  ){
