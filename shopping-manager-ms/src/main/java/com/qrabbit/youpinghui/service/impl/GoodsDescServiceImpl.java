...
import com.qrabbit.youpinghui.pojo.TbGoodsDescExample;
import com.qrabbit.youpinghui.service.GoodsDescService;
...
public class GoodsDescServiceImpl implements GoodsDescService {
	...
	public void delete(Long[] ids) {
		...
		@Override
	public ResultPageSeller findPage(TbGoodsDesc goodsDesc, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
