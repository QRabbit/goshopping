...
@Service
@Transactional
public class SpecificationServiceImplz implements SpecificationServicez {
	...
	public void add(Spectification specification) {
		...
		// 保存规格选项  多方的数据
		for(TbSpecificationOption specificationOption: specification.getSpecificationlist()){
			// 设置规格的ID:  主键回填 
	...
	public Spectification findOne(Long id){
		Spectification specification = new Spectification();
		// 根据规格ID查询规格对象
